...
kissDE is a tool from KisSplice's suite but you still can use it independantly if you have counts for your variants coming from another methods. kissDE's main function takes a table of counts as an input. It must be provided as a data frame as such:\\
\begin{verbatim}
