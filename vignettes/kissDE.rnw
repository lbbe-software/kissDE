...
\begin{tabular}{c|c|c|c|c}
   \multirow{2}{*}{Dataset} & \multirow{2}{*}{Options} & Number of & \multicolumn{2}{|c}{Running time}  \\
    & & events & \Rfunction{kissplice2counts} & \Rfunction{diffExpressedVariants} \\ \hline
  \multirow{2}{*}{AS data} & \Rcode{counts=2},  & \multirow{2}{*}{68497} & \multirow{2}{*}{14m} & \multirow{2}{*}{2h 18m} \\ 
    & \Rcode{pairedEnd=TRUE} & & & \\ \hline
  \multirow{2}{*}{SNV data} & \Rcode{counts=0}, & \multirow{2}{*}{64824} & \multirow{2}{*}{6m} & \multirow{2}{*}{2h 10m} \\
